...
import com.example.haircare.Activities.Booking.BookingActivity;
...
public class DayCutCustomerAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (dayCut != null) {
            ...
            if (activity.getClass() == com.example.haircare.Activities.Booking.BookingActivity.class) {
                com.example.haircare.Activities.Booking.BookingActivity customerBookingActivity = (com.example.haircare.Activities.Booking.BookingActivity) activity;
