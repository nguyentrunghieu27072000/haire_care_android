...
import com.example.haircare.Model.Adapter.DayCutCustomerAdapter;
import com.example.haircare.Model.Adapter.SelectTimeAdapter;
import com.example.haircare.Model.BookingTime;
import com.example.haircare.Model.Config;
import com.example.haircare.Model.DayCut;
import com.example.haircare.Model.ServicesHairSalon;
import com.example.haircare.R;
//import com.example.haircare.SharedPreferences.DataLocalManager;
...
public class BookingActivity extends AppCompatActivity {
    ...
    //Lists
    private List<ServicesHairSalon> servicesList = new ArrayList<>();
...
//        });
    ...
    private void InsertTask(String url) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                // fix id = 4 do chưa lấy dc id khi đăng nhập
                param.put("ID_User", "4");
    ...
    private void setFlowLayoutService() {
        ...
        if (servicesList != null || servicesList.size() > 0) {
            for (ServicesHairSalon service : servicesList) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == REQUEST_CODE && resultCode == RESULT_OK && data != null) {
             ...
             *
             * */
            Type type = new TypeToken<List<ServicesHairSalon>>() {
            }.getType();
